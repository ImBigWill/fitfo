...
export function renderBriefMarkdown(scan, options = {}) {
  ...
  return `${[
    ...
    "",
    "- Start with **Confirm On The Call** and **First-Call Questions** to keep the first conversation grounded.",
    "- Treat **Kickoff Research Brief** as prep, not proof; confirm assumptions with the client.",
    "- Use **Detailed Action Report** and **Proof Assets Needed** to turn the call into next steps.",
    "",
    "## Snapshot",
    "",
